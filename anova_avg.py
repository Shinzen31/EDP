...
read_bw = []
write_bw = []
write_file = f'compare/task1_rw_avg.txt'
...
for k in [0, 12, 25, 38, 50, 63, 75, 88, 100]:
    ...
    for i in reps:
        ...
        avg_r_bw.append(np.mean(temp_read_bw))
        avg_w_bw.append(np.mean(temp_write_bw))
    
    read_bw.append(avg_r_bw)
    write_bw.append(avg_w_bw)
...
read_bw = []  
write_bw = []
write_file = f'compare/task1_randrw_avg.txt'
...
read_bw = []  
write_bw = []
write_file = f'compare/task2_avg.txt'
...
read_bw = []  
write_bw = []
write_file = f'compare/task4_avg.txt'
...
read_bw = []  
write_bw = []
write_file = f'compare/task3_bw_avg.txt'
